...
module Api::V1::UserProfile
  ...
  def user_profile_json(profile, current_user, session, includes = [], context = @context)
    ...
    json[:mentor_project_2] = profile.mentor_project_2 
    json[:mentor_first_name_2] = profile.mentor_first_name_2 
    json[:mentor_last_name_2] = profile.mentor_last_name_2 
    json[:mentor_email_2] = profile.mentor_email_2 
    json[:mentor_phone_2] = profile.mentor_phone_2
    json[:mentor_project_3] = profile.mentor_project_3 
    json[:mentor_first_name_3] = profile.mentor_first_name_3 
    json[:mentor_last_name_3] = profile.mentor_last_name_3 
    json[:mentor_email_3] = profile.mentor_email_3 
    json[:mentor_phone_3] = profile.mentor_phone_3 
